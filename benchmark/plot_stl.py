...
def plotShadedSTL(filename):
    ...
    # Create light source
    ls = LightSource(azdeg=225, altdeg=0)
...
def plotSTL(filename):
    ...
    stlmesh = mesh.Mesh.from_file(filename)
    polymesh = mplot3d.art3d.Poly3DCollection(stlmesh.vectors, edgecolors='k', facecolors='w', linewidths=1, alpha=0.5)
